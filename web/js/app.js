...
import { loadModel, scoreConversation } from './model.js?v=71';
import { parseChat, toDoc } from './parse.js?v=71';
import { buildReveal } from './reveal.js?v=71';
import { playReveal } from './ui.js?v=71';
import { spikerRead, ping } from './api.js?v=71';
import { ocrToText } from './ocr.js?v=71';
import { readWhatsApp } from './wa.js?v=71';
